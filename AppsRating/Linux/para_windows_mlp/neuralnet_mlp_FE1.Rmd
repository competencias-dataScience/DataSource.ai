...
sampleSub %>% 
  ...
  sub_121_mlp_fe1
head(sub_121_mlp_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_121_mlp_fe1, file = "../submission/sub_121_mlp_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_122_mlp_fe1
head(sub_122_mlp_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_122_mlp_fe1, file = "../submission/sub_122_mlp_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_123_mlp_fe1
head(sub_123_mlp_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_123_mlp_fe1, file = "../submission/sub_123_mlp_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_124_mlp_fe1
head(sub_124_mlp_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_124_mlp_fe1, file = "../submission/sub_124_mlp_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_125_mlp_fe1
head(sub_125_mlp_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_125_mlp_fe1, file = "../submission/sub_125_mlp_fe1.csv")
```
