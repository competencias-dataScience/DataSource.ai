...
sampleSub %>% 
  ...
  sub_111_catb_roc_fe1
head(sub_111_catb_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_111_catb_roc_fe1, file = "../submission/sub_111_catb_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_112_catb_roc_fe1
head(sub_112_catb_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_112_catb_roc_fe1, file = "../submission/sub_112_catb_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_113_catb_roc_fe1
head(sub_113_catb_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_113_catb_roc_fe1, file = "../submission/sub_113_catb_roc_fe1.csv")
```
...
head(sub_114_catb_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_114_catb_roc_fe1, file = "../submission/sub_114_catb_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_115_catb_roc_fe1
head(sub_115_catb_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_115_catb_roc_fe1, file = "../submission/sub_115_catb_roc_fe1.csv")
```

# Exportando probabilidades

```{r}
write_csv(predichos_final2, file = "../probabilitys/prob_catb_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_116_catb_f1_fe1
head(sub_116_catb_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_116_catb_f1_fe1, file = "../submission/sub_116_catb_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_117_catb_f1_fe1
head(sub_117_catb_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_117_catb_f1_fe1, file = "../submission/sub_117_catb_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_118_catb_f1_fe1
head(sub_118_catb_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_118_catb_f1_fe1, file = "../submission/sub_118_catb_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_119_catb_f1_fe1
head(sub_119_catb_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_119_catb_f1_fe1, file = "../submission/sub_119_catb_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_120_catb_f1_fe1
head(sub_120_catb_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_120_catb_f1_fe1, file = "../submission/sub_120_catb_f1_fe1.csv")
```

# Exportando probabilidades

```{r}
write_csv(predichos_final2_f1, file = "../probabilitys/prob_catb_f1_fe1.csv")
```