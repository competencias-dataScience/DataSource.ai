...
head(sub_103_lgbm_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_103_lgbm_roc_fe1, file = "../submission/sub_103_lgbm_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_104_lgbm_roc_fe1
head(sub_104_lgbm_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_104_lgbm_roc_fe1, file = "../submission/sub_104_lgbm_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_105_lgbm_roc_fe1
head(sub_105_lgbm_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_105_lgbm_roc_fe1, file = "../submission/sub_105_lgbm_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_106_lgbm_roc_fe1
head(sub_106_lgbm_roc_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_106_lgbm_roc_fe1, file = "../submission/sub_106_lgbm_roc_fe1.csv")
```
...
```{r}
write_csv(predichos_final2, file = "../probabilitys/prob_lgbm_roc_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_107_lgbm_f1_fe1
head(sub_107_lgbm_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_107_lgbm_f1_fe1, file = "../submission/sub_107_lgbm_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_108_lgbm_f1_fe1
head(sub_108_lgbm_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_108_lgbm_f1_fe1, file = "../submission/sub_108_lgbm_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_109_lgbm_f1_fe1
head(sub_109_lgbm_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_109_lgbm_f1_fe1, file = "../submission/sub_109_lgbm_f1_fe1.csv")
```
...
sampleSub %>% 
  ...
  sub_110_lgbm_f1_fe1
head(sub_110_lgbm_f1_fe1)
```

- **Exportando predicciones:**

```{r}
write_csv(sub_110_lgbm_f1_fe1, file = "../submission/sub_110_lgbm_f1_fe1.csv")
```

# Exportando probabilidades

```{r}
write_csv(predichos_final2_f1, file = "../probabilitys/prob_lgbm_f1_fe1.csv")
```