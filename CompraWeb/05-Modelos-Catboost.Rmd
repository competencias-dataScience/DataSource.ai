...
```{r}
# Mejores parámetros
mejor_roc <- select_best(catb_tuned, metric = "f_meas")
...
```{r}
write_csv(sub_04, file = "submission/sub_04.csv")
```
...
```{r}
write_csv(predichos_final2, file = "probabilitys/prob_catb.csv")
```
