...
```{r}
# Mejores parámetros
mejor_roc <- select_best(lgbm_tuned, metric = "f_meas")
...
```{r}
write_csv(sub_05, file = "submission/sub_05.csv")
```
...
```{r}
write_csv(predichos_final2, file = "probabilitys/prob_lgbm.csv")
```
